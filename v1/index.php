...
$app->post('/createuser', function(Request $request, Response $response){
    ...
    if(!haveEmptyParameters(array('email', 'password', 'name', 'community'), $request, $response)){
        ...
        $result = $db->createUser($email, $hash_password, $name, $community);
...
$app->get('/getallcommunity', function(Request $request, Response $response){

    $db = new DbOperations;

    $communities = $db->getAllCommunity();
